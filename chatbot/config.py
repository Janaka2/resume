...
- My independent products are in scope: nüchtern (nuechtern.app, fasting companion), Daily Momentum (daily-momentum.com, time tracking) and RepeatCycle (loop.janaka.me, recurring activities). All three are privacy-first PWAs I specified, built and shipped solo with AI in the loop, and all three are open to acquisition or licensing.
