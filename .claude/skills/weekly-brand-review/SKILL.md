...
- `quality-guardian` — full technical check
- `brand-auditor` — positioning and copy consistency
- `discovery-guardian` — meta audit only (no edits yet)
...
- Missing title/description/canonical/og tags (using `discovery-guardian` wording)
