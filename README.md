...
**Senior Java Engineer & Solution Architect, Zug 🇨🇭.** Banking-grade Java engineering, now bringing practical AI into regulated systems. Hub for the blog, lab, AI notes, CV, Janaka Academy and three products: [nüchtern](https://nuechtern.app/), [Daily Momentum](https://daily-momentum.com/) and [Loop](https://loop.janaka.me/).
